...
public class ScheduleMeeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendInviteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sendInviteNav = new Intent(ScheduleMeeting.this, ChatList.class);
                String sender = getIntent().getStringExtra("username");
                sendInviteNav.putExtra("username", sender);
                sendInvite();
                startActivity(sendInviteNav);
            }
        });
    }
    ...
    public void sendInvite() {
        ...
        ArrayList<String> parts = MeetingParticipants();
        MeetingInfo meetingInfo = new MeetingInfo(meetingLink, date, time);
        ReadWriteSnippets rwsOutgoingMeeting = new ReadWriteSnippets();
        rwsOutgoingMeeting.writeNewMeetingWithListeners(parts, meetingInfo);
    ...
    public ArrayList<String> MeetingParticipants() {
    ...
    public static class MeetingInfo {
        ...
        MeetingInfo(String meetingLink, String date, String time) {
